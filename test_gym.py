...
def run(scale, N_0, gamma=0.9):
    ...
    #q_function = QDeep(n_actions=env.action_space.n, n_feat=n_states, discrete_scale=scale)
    q_function = QTabular(n_actions=env.action_space.n, n_feat=n_states, discrete_scale=scale)
